                ...
                <div class="modal-body">
                    <form action="{{ route('sucursal.store') }}" method="POST">
                        ...
                        <div class="mb-4 px-2 col-12 ">
                            ...
                            <input required type="text" class="input input__text" name="distrito"
                                value="{{ old('distrito') }}">
                            @error('distrito')
                                <p class="error-message text-danger">{{ $message }}</p>
                            @enderror
                ...
                <tbody>
                    @foreach ($sql as $key => $item)
                        <tr>
                            ...
                            <td>{{ $item->nombre }}</td>
                            <td>{{ $item->barrio . '-' . $item->Provincia . '-' . $item->Departamento }}</td>
                                            ...
                                            <form action="{{ route('sucursal.update', $item->id_sucursal) }}"
                                                ...
                                                <div class="mb-4 px-2 col-12 ">
                                                    ...
                                                    <input required type="text" class="input input__text"
                                                        name="distrito" value="{{ old('distrito', $item->barrio) }}">
                                                    @error('distrito')
                                                        <p class="error-message text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
