...
class UsuarioController extends Controller
{
    ...
    public function index()
    {
        ...
        LEFT JOIN provincias ON sucursal.distrito = provincias.idProv
        LEFT JOIN departamentos ON provincias.idDepa = departamentos.idDepa

         ");
        $sucursal = DB::select(" SELECT sucursal.id_sucursal,sucursal.nombre,sucursal.direccion,sucursal.telefono,sucursal.barrio,
        provincias.Provincia,departamentos.Departamento FROM sucursal
