...
Route::get("estado-destino-{id}", [EnvioController::class, "ponerDestino"])->name("estado.enDestino")->middleware('verified');
...
Route::get("buscar-provincia-{id}-{id2}", [PaisesController::class, "buscarProvincia"])->name("buscar.provincia")->middleware('verified');
...
/* AJAX EN VISTA DE REGISTRO ENVIOS */
Route::get("buscar-precio-{id_tipo_envio}",[EnvioController::class, "buscarPrecio"])->name("buscarPrecio.envio");